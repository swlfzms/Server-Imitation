...
public class ConnectionPool {
	...
	private ConnectionPool() {
		...
		if (ConnectionPool.debugLogger.isDebugEnabled()) {
			ConnectionPool.debugLogger.debug("MethodName:" + methodName
					+ " ClassName:" + className);
		}
		...
		try {
			String path = ConnectionPool.class.getClassLoader().getResource("")
					.toURI().getPath();
			...
			if (ConnectionPool.errorLogger.isDebugEnabled()) {
				ConnectionPool.errorLogger.error("error Message:"
						+ e.getMessage() + ", below method:");
				ConnectionPool.errorLogger.error("MethodName:" + methodName
						+ " ClassName:" + className);
			}
		}	
